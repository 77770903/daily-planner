...
const WeekendCard = ({ task, onToggle, index = 0 }) => {
  const { title, start_time, is_completed } = task
  ...
  return (
    ...
    >
      <div
        className={`relative rounded-2xl p-5 transition-all duration-200 ease-out card-hover ${
          is_completed
